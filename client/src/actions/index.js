...
export const UPDATE_EXERCISE_START = "UPDATE_EXERCISES_START";
export const UPDATE_EXERCISE_SUCCESS = "UPDATE_EXERCISES_SUCCESS";
export const UPDATE_EXERCISE_FAILURE = "UPDATE_EXERCISES_FAILURE";
